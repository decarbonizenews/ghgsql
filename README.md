...
The `examples` subdirectory contains some usage examples in Python as well as some SQL
queries that can be executed using the `ghgsql` script (see file headers for details).
